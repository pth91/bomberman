    ...
    if not os.path.isfile("my-saved-model.pt"):
      ...
      #  weights = np.random.rand(len(ACTIONS))
       # self.model = weights / weights.sum()
        self.model = np.zeros((3, 6, 9, 9, 9, 9, 9, 6, 6)) # 0-7 dim featurespace, 8 #Actions
...
def act(self, game_state: dict) -> str:
    ...
    if hasattr(self, 'model'):
        ...
        self.logger.debug(f'argmax of {self.model[features[0], features[1] ,features[2], features[3], features[4], features[5], features[6], features[7]]}')
        return action
...
#    channels.append(field[a_pos[0], a_pos[1]]) #current
    ...
    channels.append(field[a_pos[0]- 1, a_pos[1]]) #left 
    channels.append(field[a_pos[0]+ 1, a_pos[1]])# right
    channels.append(field[a_pos[0], a_pos[1]- 1]) #up
    channels.append(field[a_pos[0], a_pos[1]+ 1]) #down
